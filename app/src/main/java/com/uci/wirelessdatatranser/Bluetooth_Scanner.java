...
public class Bluetooth_Scanner {
    private static final String TAG = Bluetooth_Scanner.class.getSimpleName();
    ...
    public Bluetooth_Scanner(BluetoothAdapter adapter, UUID[] servicesToDiscover, BluetoothAdapter.LeScanCallback callback) {
    ...
    //implements runnable so we can put it into class thread without having to call public void run() function in thread
    ...
    scanRecord 	byte: The content of the advertisement record offered by the remote device.
        ...
        */
        ...
        @Override
        public void run() {
            //runs startlescan callback function which scans for devices and returns result to onlescan
